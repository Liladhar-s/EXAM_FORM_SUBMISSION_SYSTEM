...
for ($i = 0; $i < sizeof($checkbox1); $i++) {
  $query = "SELECT sub_code, credits  from add_s5 where sub_name = '$checkbox1[$i]'";
...
require_once('../connection.php');
$user = $_SESSION['user'];
$q = mysqli_query($con, "SELECT * FROM add_s5");
...
?>
  ...
  <head>
    ...
    <title>CSE | 5th Sem</title>
  </head>

  <body>
    <h1 class="myh1">5th Semester Computer Science & Engineering Subjects</h1>
    <div class="forms">
