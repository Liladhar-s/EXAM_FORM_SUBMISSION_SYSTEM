...
for ($i = 0; $i < sizeof($checkbox1); $i++) {
  $query = "SELECT sub_code, credits  from add_s3 where sub_name = '$checkbox1[$i]'";
...
require_once('../connection.php');
$user = $_SESSION['user'];
$q = mysqli_query($con, "SELECT * FROM add_s3");
...
?>
  ...
  <head>
    ...
    <title>CSE | 3rd Sem</title>
  </head>

  <body>
    <h1 class="myh1">3rd Semester Computer Science & Engineering Subjects</h1>
    <div class="forms">
